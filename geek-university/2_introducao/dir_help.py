...
help -> apresenta a documentacao/como utilizar os atributos/propriedades e funções/metodos disponiveis para determinado tipo de dado ou variavel.
    help(tipo de dado/variavel)
"""